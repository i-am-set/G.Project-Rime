...
@onready var inventory_manager: InventoryManager = $"../InventoryPanel/MarginContainer/VBoxContainer/InventoryManager"

# Speed of rotation in degrees per second.
var rotation_speed = 90.0

var right_clicked_item_slot : int
var inv_item : Array : set = set_inv_item
...
#func _on_split_one_pressed():
	#inventory_manager.subinventory_container.quick_split_item_one(right_clicked_item_ref)
