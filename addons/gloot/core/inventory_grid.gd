...
func set_item_rotation(item: InventoryItem, rotated: bool) -> bool:
	return _constraint_manager.get_grid_constraint().set_item_rotation(item, rotated, false)


func rotate_item(item: InventoryItem, is_held: bool) -> bool:
	return _constraint_manager.get_grid_constraint().rotate_item(item, is_held)
